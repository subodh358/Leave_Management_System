    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(choices=[(1, 'Employee'), (2, 'Manager')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('my_manager', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.Manager')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
